    ...
    <div class="page-wrapper">
        ...
        <div class="topbar">
            ...
            <nav class="navbar-custom">
                ...
                <ul class="list-unstyled topbar-nav mb-0">
                    ...
                    <li class="creat-btn">
                        <div class="nav-link">
                            <a class=" btn btn-sm btn-soft-primary" href="agregar_servicio.php" role="button"><i class="fas fa-plus me-2"></i>Agregar servicio</a>
                        </div>
                    </li>
                </ul>
            </nav>
        ...
        <div class="page-content">
                                        ...
                                        <table class="table table-striped mb-0">
                                            ...
                                            <tbody>
                                                <tr style="text-align: center;">
                                                    ...
                                                    <td></td>
                                                    <td>
                                                        <a href="editar_servicio.php"><i class="las la-pen text-secondary" style="font-size: 25px;"></i></a>
            ...
            <footer class="footer text-center text-sm-start">
                ...
                </script> Dastone <span class="text-muted d-none d-sm-inline-block float-end">Mauro Sebastian Prystupa</span>
            </footer>
            <!--end footer-->
        </div>
        <!-- end page content -->
